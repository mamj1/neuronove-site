...
# nacteni datasetu
data_amazon = pd.read_csv('/home/jupyter-mamj01@vse.cz/sem/amazon_cells_labelled.txt', names=['text', 'sentiment'], sep='\t')
data_imdb = pd.read_csv('/home/jupyter-mamj01@vse.cz/sem/imdb_labelled.txt', names=['text', 'sentiment'], sep='\t')
data_yelp = pd.read_csv('/home/jupyter-mamj01@vse.cz/sem/yelp_labelled.txt', names=['text', 'sentiment'], sep='\t')
